...
/**
	...
	* Example usage:
	*
	* $c = new Shineisp_Commons_jsCompressor();
	* $c->add("my-app.js")
	*   ->add("popup.js")
	*   ->advancedMode()
	*   ->useClosureLibrary()
...
class Shineisp_Commons_jsCompressor {
	...
	/**
	 * Fast way to minify the javascript code
	 * 
	 * @return mixed
	 */
	function _minify() {
		
		$buffer = $this->_readSources();
	...
	/**
	 * Request to the closure-compiler webservice
	 * This method request more time to be executed
	 * @return string
	 */
