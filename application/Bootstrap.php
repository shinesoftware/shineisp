...
class Bootstrap extends Zend_Application_Bootstrap_Bootstrap {
	...
	protected function _initRouter() {
		...
		# http://www.shineisp.com/reviews/myproduct.html
		$router->addRoute ( 'review', new Zend_Controller_Router_Route_Regex ( 'review/(.+)\.html', array ('module' => 'default', 'controller' => 'products', 'action' => 'addreview' ), array (1 => 'q' ), 'review/%s.html' ) );
