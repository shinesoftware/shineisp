...
class NewslettersSubscribers extends BaseNewslettersSubscribers
{
    ...
    public static function grid($rowNum = 10) {
        ...
        $config ['datagrid'] ['columns'] [] = array ('label' => $translator->translate ( 'Firstname' ), 'field' => 'c.firstname', 'alias' => 'firstname', 'sortable' => true, 'searchable' => true, 'type' => 'string' );
        ...
        $config ['datagrid'] ['fields'] = "s.subscriber_id, s.email as email, c.firstname as firstname, c.lastname as lastname, c.company as company, DATE_FORMAT(s.subscriptiondate, '".Settings::getMySQLDateFormat('dateformat')." %H:%i:%s') as subscriptiondate";
        $config ['datagrid'] ['rownum'] = $rowNum;

        $doctrine = Doctrine_Query::create ()->from ( 'NewslettersSubscribers s' )->leftJoin ( 's.Customers c' );

        $config ['datagrid'] ['dqrecordset'] = $doctrine->select ( $config ['datagrid'] ['fields'] );
