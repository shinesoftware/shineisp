	...
	public static function createForm($groupid) {
		...
		if (! empty ( $records )) {
			foreach ( $records as $record ) {
				...
				$form->addElement ( $record['type'], $record ['var'], $style + array ('decorators' => array('Composite'), 'filters' => array ('StringTrim' ), 'label' => $record ['name'], 'description' => $record ['description'], 'class' => 'form-control obj_' . $record ['var'] ) );
