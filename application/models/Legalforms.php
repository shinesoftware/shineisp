...
class Legalforms extends BaseLegalforms {
	...
	public static function grid($rowNum = 10) {
		...
		$config ['datagrid'] ['columns'] [] = array ('label' => null, 'field' => 't.legalform_id', 'alias' => 'legalform_id', 'type' => 'selectall', 'attributes' => array('width' => 50 ) );
		$config ['datagrid'] ['columns'] [] = array ('label' => $translator->translate ( 'ID' ), 'field' => 'l.legalform_id', 'alias' => 'legalform_id', 'sortable' => true, 'searchable' => true, 'type' => 'string', 'attributes' => array('width' => 50 ) );
