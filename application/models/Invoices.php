...
class Invoices extends BaseInvoices {
	...
	public static function grid($rowNum = 10) {
		...
		$config ['datagrid'] ['columns'] [] = array ('label' => null, 'field' => 'i.invoice_id', 'alias' => 'invoice_id', 'type' => 'selectall', 'attributes' => array('class' => 'span1') );
	...
	public static function graph(array $years) {
		...
		$dataset['labels'][] = array('type' =>'number', 'title' => $translator->translate('Revenue (Taxable Income)'));
		$dataset['labels'][] = array('type' =>'number', 'title' => $translator->translate('Net Revenue (Taxable Income less Costs)'));
	...
	public static function graph_week($from, $to) {
		...
		$dataset['title'] = $translator->_( '%s Week Performance', $isp['company'] );
