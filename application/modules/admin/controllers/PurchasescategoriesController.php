...
class Admin_PurchasescategoriesController extends Shineisp_Controller_Admin {
	...
	public function listAction() {
		...
		$this->view->buttons = array(array("url" => "/admin/purchasescategories/new/", "label" => $this->translator->translate('New'), "params" => array('css' => array('btn'))));
	...
	public function newAction() {
		...
		$this->view->buttons = array(array("url" => "#", "label" => $this->translator->translate('Save'), "params" => array('css' => array('btn'), 'id' => 'submit')),
									 array("url" => "/admin/purchasescategories/list", "label" => $this->translator->translate('List'), "params" => array('css' => array('btn'))));
	...
	public function deleteAction() {
		...
		try {
			...
			$this->_helper->redirector ( 'list', 'purchasescategories', 'admin', array ('mex' => $this->translator->translate ( 'Unable to process the request at this time.' ) . ": " . $e->getMessage (), 'status' => 'error' ) );
		}
	...
	public function editAction() {
		...
		$this->view->buttons = array(
				...
				array("url" => "/admin/purchasescategories/list", "label" => $this->translator->translate('List'), "params" => array('css' => array('btn'), 'id' => 'submit')),
				array("url" => "/admin/purchasescategories/new/", "label" => $this->translator->translate('New'), "params" => array('css' => array('btn'))),
		);
		...
		if (! empty ( $id ) && is_numeric ( $id )) {
			...
			$this->view->buttons[] = array("url" => "/admin/purchasescategories/confirm/id/$id", "label" => $this->translator->translate('Delete'), "params" => array('css' => array('btn')));
	...
	public function processAction() {
		...
		if ($form->isValid ( $request->getPost () )) {
			...
			try {
				...
				$this->_helper->redirector ( 'edit', 'purchasescategories', 'admin', array ('id' => $id, 'mex' => $this->translator->translate ( 'Unable to process the request at this time.' ) . ": " . $e->getMessage (), 'status' => 'error' ) );
			}
