...
class Admin_TicketsController extends Shineisp_Controller_Admin {
	...
	public function listAction() {
		...
		$this->view->buttons = array(array("url" => "/admin/tickets/new/", "label" => $this->translator->translate('New'), "params" => array('css' => array('btn'))));
	...
	public function newAction() {
		...
		$this->view->buttons = array(array("url" => "#", "label" => $this->translator->translate('Save'), "params" => array('css' => array('btn'), 'id' => 'submit')),
								array("url" => "/admin/tickets/list", "label" => $this->translator->translate('List'), "params" => array('css' => array('btn'))));
	...
	public function editAction() {
		...
		$this->view->buttons = array(
				...
				array("url" => "/admin/tickets/list/", "label" => $this->translator->translate('List'), "params" => array('css' => array('btn'), 'id' => 'submit')),
				array("url" => "/admin/tickets/new/", "label" => $this->translator->translate('New'), "params" => array('css' => array('btn'))),
		);
