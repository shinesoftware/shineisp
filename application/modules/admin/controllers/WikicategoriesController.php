...
class Admin_WikicategoriesController extends Zend_Controller_Action {
	...
	public function confirmAction() {
		...
		try {
			if (is_numeric ( $id )) {
				...
				$this->view->description = $this->translator->translate ( 'If you delete the wiki category the record will no longer available' );
	...
	public function deleteAction() {
		...
		try {
			...
			$this->_helper->redirector ( 'list', 'wikicategories', 'admin', array ('mex' => $this->translator->translate ( 'Unable to process request at this time.' ) . ": " . $e->getMessage (), 'status' => 'error' ) );
		}
	...
	public function processAction() {
		...
		if ($form->isValid ( $request->getPost () )) {
			...
			try {
				...
				$this->_helper->redirector ( 'edit', 'wikicategories', 'admin', array ('id' => $id, 'mex' => $this->translator->translate ( 'Unable to process request at this time.' ) . ": " . $e->getMessage (), 'status' => 'error' ) );
			}
