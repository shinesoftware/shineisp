...
class Admin_SubscribersController extends Shineisp_Controller_Admin {
	...
	public function editAction() {
		...
		$this->view->buttons = array(
				...
				array("url" => "/admin/subscribers/list", "label" => $this->translator->translate('List'), "params" => array('css' => array('button', 'float_right'), 'id' => 'submit')),
				array("url" => "/admin/subscribers/new/", "label" => $this->translator->translate('New'), "params" => array('css' => array('button', 'float_right'))),
		);
		...
		if (! empty ( $id ) && is_numeric ( $id )) {
			...
			if (! empty ( $rs [0] )) {
				...
				$this->view->buttons[] = array("url" => "/admin/subscribers/confirm/id/$id", "label" => $this->translator->translate('Delete'), "params" => array('css' => array('button', 'float_right')));
