...
class Admin_WikiController extends Shineisp_Controller_Admin {
	...
	public function listAction() {
		...
		$this->view->buttons = array(array("url" => "/admin/wiki/new/", "label" => $this->translator->translate('New'), "params" => array('css' => null)));
	...
	public function newAction() {
		...
		$this->view->buttons = array(array("url" => "#", "label" => $this->translator->translate('Save'), "params" => array('css' => null,'id' => 'submit')),
									 array("url" => "/admin/wiki/list", "label" => $this->translator->translate('List'), "params" => array('css' => null)));
	...
	public function editAction() {
		...
		$this->view->buttons = array(
				...
				array("url" => "/admin/wiki/list", "label" => $this->translator->translate('List'), "params" => array('css' => null,'id' => 'submit')),
				array("url" => "/admin/wiki/new/", "label" => $this->translator->translate('New'), "params" => array('css' => null)),
		);
		...
		if (! empty ( $id ) && is_numeric ( $id )) {
			...
			if (! empty ( $rs [0] )) {
				$form->populate ( $rs [0] );
				$this->view->buttons[] = array("url" => "/admin/wiki/confirm/id/$id", "label" => $this->translator->translate('Delete'), "params" => array('css' => null));
			}
		}
