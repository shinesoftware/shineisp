...
class Admin_LanguagesController extends Zend_Controller_Action {
	...
	public function deleteAction() {
		...
		try {
			...
			$this->_helper->redirector ( 'list', 'languages', 'admin', array ('mex' => $this->translator->translate ( 'Unable to process request at this time.' ) . ": " . $e->getMessage (), 'status' => 'error' ) );
		}
	...
	public function processAction() {
		...
		if ($form->isValid ( $request->getPost () )) {
			...
			try {
				...
				$this->_helper->redirector ( 'edit', 'languages', 'admin', array ('id' => $id, 'mex' => $this->translator->translate ( 'Unable to process request at this time.' ) . ": " . $e->getMessage (), 'status' => 'error' ) );
			}
