...
class Admin_LanguagesController extends Shineisp_Controller_Admin {
	...
	public function editAction() {
		...
		$this->view->buttons = array(
				...
				array("url" => "/admin/languages/list", "label" => $this->translator->translate('List'), "params" => array('css' => array('button', 'float_right'), 'id' => 'submit')),
				array("url" => "/admin/languages/new/", "label" => $this->translator->translate('New'), "params" => array('css' => array('button', 'float_right'))),
		);
		...
		if (! empty ( $id ) && is_numeric ( $id )) {
			...
			$this->view->buttons[] = array("url" => "/admin/languages/confirm/id/$id", "label" => $this->translator->translate('Delete'), "params" => array('css' => array('button', 'float_right')));
