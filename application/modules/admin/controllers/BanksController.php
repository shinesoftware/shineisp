...
class Admin_BanksController extends Shineisp_Controller_Admin {
	...
	public function listAction() {
		...
		$this->view->buttons = array(array("url" => "/admin/banks/new/", "label" => $this->translator->translate('New'), "params" => array('css' => null)));
	...
	public function newAction() {
		...
		$this->view->buttons = array(array("url" => "#", "label" => $this->translator->translate('Save'), "params" => array('css' => null,'id' => 'submit')),
									 array("url" => "/admin/banks/list", "label" => $this->translator->translate('List'), "params" => array('css' => null)));
	...
	public function editAction() {
		...
		if (! empty ( $id ) && is_numeric ( $id )) {
			...
			$this->view->buttons[] = array("url" => "/admin/banks/confirm/id/$id", "label" => $this->translator->translate('Delete'), "params" => array('css' => null));
