...
class Api_OrdersitemsController extends Shineisp_Api_Shineisp_Controller_Action {
    ...
    public function soapAction(  ) {
        self::soap( 'Shineisp_Api_Shineisp_Ordersitems' );
        exit();
    }
    
    public function wsdlAction(  ) {
        self::wsdl( 'Shineisp_Api_Shineisp_Ordersitems' );
        exit();
    }
